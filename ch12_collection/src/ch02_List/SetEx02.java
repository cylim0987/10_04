...
public class SetEx02 {
	...
	public static void main(String[] args) {
		// Set인터페이스로 선언된 set생성
		// Member String sno, String name으로 구성
		...
		while (itor.hasNext()) {
			Member1 m = itor.next();
			System.out.println(m);  // Member1 [sno=3, name=임꺽정]
									// Member1 [sno=1, name=홍길동]
									// Member1 [sno=2, name=일지매]
									// Member1 [sno=2, name=일지매] //hashCode와 equal 오버라이드.
		 ...
		 * 
		 * 
		 * Member1.set = new Member1 String sno1 = "홍길동"; String sno2 = "홍길동"; String
		 * sno3 = "홍길동"; String sno2 = "홍길동";
		 * 
